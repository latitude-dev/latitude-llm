...
For Effect version upgrades and the `EffectService` (`@repo/effect-service`) / upstream `Context.Service` story, see [docs/effect-services.md](../../../docs/effect-services.md).
