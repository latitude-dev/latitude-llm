...
- `headline.svg`, `wordmark.svg`, `benchmark.svg`: transparent outlined Figma text exports (contents only) from nodes `7229:144645`, `7229:144646`, and `7229:144647`. Exports have tight artwork bounds; the renderer positions them by their absolute render bounds rather than their text boxes.
