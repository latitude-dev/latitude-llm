...
export const EditorSettings = memo(({ copilotEnabled }: { copilotEnabled: boolean }) => {
  const { value: showLineNumbers, setValue: setShowLineNumbers } = useLocalStorage({
  ...
  const { value: autoClosingTags, setValue: setAutoClosingTags } = useLocalStorage({
