...
function DocumentLogTrace({
  ...
  if (isLoading) {
    ...
    return (
      <div className='w-full h-full flex items-center justify-center gap-2 p-4 border-b border-border rounded-b-xl'>
  ...
  return (
    <CollapsibleBox
      ...
      scrollable={false}
      expandedContent={
        <div className='w-full h-full max-h-96 overflow-y-auto custom-scrollbar scrollable-indicator z-10'>
