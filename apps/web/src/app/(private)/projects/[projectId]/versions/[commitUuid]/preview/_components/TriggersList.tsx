...
export function TriggersList({
  ...
  const onRunChatTrigger: OnRunChatTrigger = useCallback(({ trigger }) => {
    setActiveChatTrigger(trigger)
  ...
  return (
    ...
    >
      ...
      {mode !== 'chat' && activeChatTrigger ? (
        <div className='sticky bottom-6'>
          <ChatTriggerTextarea
            chatTrigger={activeChatTrigger}
            chatFocused={chatBoxFocused}
            onRunTrigger={onRunTrigger}
          />
        </div>
      ) : null}
