...
export function RunsPage({
  ...
  useEffect(() => setActiveSearch(serverActive.search), [serverActive.search]) // prettier-ignore
  ...
  useEffect(() => setCompletedSearch(serverCompleted.search), [serverCompleted.search]) // prettier-ignore
