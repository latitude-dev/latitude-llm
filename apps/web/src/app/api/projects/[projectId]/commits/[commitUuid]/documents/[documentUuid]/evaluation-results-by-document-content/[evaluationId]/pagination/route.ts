...
import { computeEvaluationResultsByDocumentContentCount } from '@latitude-data/core/services/evaluationResults/computeEvaluationResultsByDocumentContent'
...
export const GET = errorHandler(
  authHandler(
    async (
      ...
      const count = await computeEvaluationResultsByDocumentContentCount({
        workspace,
        commit,
        evaluation,
