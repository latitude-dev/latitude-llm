...
function ModelEntryCostBar({ entry }: { entry: ModelCostEntry }) {
  ...
  const allSegments: Segment[] = [
    { key: 'prompt', color: CATEGORY_COLORS.prompt, cost: entry.input.prompt.cost ?? 0 },
    { key: 'cached', color: CATEGORY_COLORS.cached, cost: entry.input.cached.cost ?? 0 },
    { key: 'reasoning', color: CATEGORY_COLORS.reasoning, cost: entry.output.reasoning.cost ?? 0 },
    { key: 'completion', color: CATEGORY_COLORS.completion, cost: entry.output.completion.cost ?? 0 },
  ]
