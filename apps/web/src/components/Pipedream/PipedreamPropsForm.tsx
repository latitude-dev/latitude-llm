    ...
    >
      ...
      {props.length === 0 && (
        <div className='flex items-center justify-center w-full h-32'>
          <Text.H5 color='foregroundMuted'>Nothing to configure</Text.H5>
        </div>
      )}
    </div>
  )
...
function PipedreamPropsForm({
  ...
  if (prop.type === 'boolean') {
    return (
      <BooleanPipedreamProp prop={prop} value={value} setValue={setValue} />
    )
  }
  ...
  return <UnknownPipedreamProp prop={prop} value={value} setValue={setValue} />
}
