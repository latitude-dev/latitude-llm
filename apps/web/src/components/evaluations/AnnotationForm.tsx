...
import { type AnnotationFormProps, EVALUATION_SPECIFICATIONS } from './index'

export default function AnnotationForm<T extends EvaluationType, M extends EvaluationMetric<T>>({
  evaluation,
  ...rest
        ...
        <div className='flex flex-col gap-y-2'>
          ...
          {evaluation.configuration.reverseScale && (
            <Text.H6M>
              Note:{' '}
              <Text.H6>
                This evaluation's scale is reversed. That means a lower score is better.
              </Text.H6>
            </Text.H6M>
          )}
        </div>
