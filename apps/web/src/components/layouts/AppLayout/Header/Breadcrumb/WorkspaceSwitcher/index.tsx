import { DropdownMenu, DropdownMenuTrigger } from '@latitude-data/web-ui/atoms/DropdownMenu'
...
export function WorkspaceSwitcher() {
  ...
  const { data: availableWorkspaces, switchToWorkspace, isSwitching } = useAvailableWorkspaces()

  // Don't render dropdown if there's only one workspace or no workspaces
  const shouldShowDropdown = availableWorkspaces && availableWorkspaces.length > 1
