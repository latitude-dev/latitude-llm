 ...
 */
export function useIsLatitudeProvider({ metadata }: { metadata: ResolvedMetadata | undefined }) {
  ...
  useEffect(() => {
    ...
    const isLimited = providerName === envClient.NEXT_PUBLIC_DEFAULT_PROVIDER_NAME
