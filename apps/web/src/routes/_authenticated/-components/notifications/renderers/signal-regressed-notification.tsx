import { signalRegressedPayloadSchema } from "@domain/notifications"
...
export function SignalRegressedNotification({ notification }: { readonly notification: NotificationRecord }) {
  const parsed = signalRegressedPayloadSchema.safeParse(notification.payload)
  ...
  return (
    <BaseNotification
      ...
      icon={<RotateCcwIcon />}
      title="A resolved signal came back."
      url={url}
    >
