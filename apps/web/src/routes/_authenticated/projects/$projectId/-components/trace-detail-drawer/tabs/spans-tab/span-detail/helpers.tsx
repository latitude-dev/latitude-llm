import { CodeBlock, cn, Text } from "@repo/ui"
...
export function hasAnyTokens(span: SpanDetailRecord): boolean {
  return (
    span.tokensInput > 0 ||
    span.tokensOutput > 0 ||
    span.tokensCacheRead > 0 ||
    span.tokensCacheCreate > 0 ||
    span.tokensReasoning > 0
  )
}
