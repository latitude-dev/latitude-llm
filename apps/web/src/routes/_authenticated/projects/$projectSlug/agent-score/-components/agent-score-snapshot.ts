...
export async function createScoreSnapshot(input: ScoreSnapshotInput): Promise<ScoreSnapshotImage> {
  ...
  context.drawImage(headline, 225.338, 79.813, 820.607, 206.828)
  context.drawImage(wordmark, 123.267, 620.56, 200.346, 30.04)
  context.drawImage(benchmark, 975.586, 621.04, 203.804, 29.56)
  context.save()
  context.translate(87, 637)
  context.rotate(-Math.PI / 2)
  context.drawImage(logo, -20, -20, 40, 40)
  context.restore()
  drawScoreDisc({ context, x: 404.276, y: 404.276, size: 460.724, score: snapshot.score, total: true })
