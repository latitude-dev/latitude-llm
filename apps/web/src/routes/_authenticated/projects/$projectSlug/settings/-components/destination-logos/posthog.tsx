...
/** PostHog wordmark. Brand fills are fixed; the dark glyph follows the theme foreground for contrast. */
export function PosthogLogo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 50 30" aria-hidden="true" {...props}>
      <path
        fill="#1D4AFF"
