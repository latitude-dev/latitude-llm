...
export const Route = createFileRoute("/_authenticated/settings/myself")({
  component: MyselfSettingsPage,
})
...
function MyselfSettingsPage() {
  ...
  return (
    <Container className="flex flex-col gap-8 pt-14">
      <Text.H4 weight="bold">Myself</Text.H4>
