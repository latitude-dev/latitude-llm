...
const COLOR_GROUPS: { title: string; colors: { token: string; label: string; fgToken?: string }[] }[] = [
  ...
  },
  {
    ...
    colors: [
      ...
      { token: "latte", label: "latte" },
      { token: "latte-border", label: "latte-border" },
      { token: "latte-background", label: "latte-background" },
      { token: "latte-input-background", label: "latte-input-background" },
      { token: "latte-input-foreground", label: "latte-input-foreground", fgToken: "latte-input-background" },
      { token: "latte-output-foreground", label: "latte-output-foreground", fgToken: "latte-background" },
      { token: "latte-widget-background", label: "latte-widget-background" },
      { token: "latte-badge-border", label: "latte-badge-border" },
    ],
  },
  {
    title: "Charts",
