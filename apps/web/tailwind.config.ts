  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "latte-border": "hsl(var(--latte-border) / <alpha-value>)",
        "latte-background": "hsl(var(--latte-background) / <alpha-value>)",
        "latte-input": {
        ...
        "latte-widget": "hsl(var(--latte-widget-background) / <alpha-value>)",
        "latte-badge-border": "hsl(var(--latte-badge-border) / <alpha-value>)",
      },
      borderRadius: {
