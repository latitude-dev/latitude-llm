...
const USAGE = `
Usage:
  pnpm --filter @app/workers signal-score-evidence:backfill [options]
  node --enable-source-maps apps/workers/dist/scripts/backfill-signal-score-evidence.cjs [options]
