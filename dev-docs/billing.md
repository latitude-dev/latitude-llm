...
- trace search stamps `retention_days` onto `trace_search_documents` and `trace_message_occurrences`; shared `message_embeddings` TTL from `last_seen_at`
...
- `message_embeddings`: `last_seen_at + 90 days`
