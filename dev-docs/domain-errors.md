...
- **Reference implementation:** `packages/domain/issues/src/errors.ts` — see also *Domain errors (`@domain/issues` reference pattern)* in [`./signals.md`](./signals.md) and [effect-and-errors](../.agents/skills/effect-and-errors/SKILL.md).
