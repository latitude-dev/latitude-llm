...
Monitors are exposed as a public REST surface under `/v1/projects/{projectSlug}/monitors`, with monitor CRUD and monitor-alert reads/updates as separate operation families:
