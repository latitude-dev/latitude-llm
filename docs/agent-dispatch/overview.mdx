...
<Tip>
The same query tools power [Artifacts](/more/artifacts): ask the agent for a report or a dashboard and it
turns these queries into a self-contained HTML page.
</Tip>
