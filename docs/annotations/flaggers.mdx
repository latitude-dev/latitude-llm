...
<AccordionGroup>
  <Accordion title="Refusal">
    ...
    Not flagged: a correct refusal, where the request is unsafe, unsupported, missing context the agent needs, or a capability none of the agent's declared tools can fulfill.
  </Accordion>
