...
Flaggers detect known failure categories on every completed trace and write a published annotation immediately. That annotation flows through the rest of the system: scores, issue discovery, analytics, and alignment.
...
| **[Saved searches](../search/saved-searches)** | Custom saved searches for anything flaggers don't cover. |
...
- [Search](../search/overview): Saved searches for scopes flaggers don't cover
