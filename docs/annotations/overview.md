...
4. **Optionally link an issue**: choose a known issue, or let Latitude match it during signal discovery.
...
| **[Signals](../signals/overview)** | Failed annotations can cluster into trackable issues. |
