...
Youc an now select logs from the logs section and automatically create a
...
evaluating your prompts at scale, but not have to rely on Latitude's Gateway
in order to run your prompts from your code. [docs](https://docs.latitude.so/guides/sdk/javascript-typescript-sdk#running-a-document-locally).
