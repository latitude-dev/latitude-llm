...
## Fix Segment ID Column Type

A fix was implemented to correct the segment ID column type. [PR #1442](https://github.com/latitude-dev/latitude-llm/pull/1442)

## Pipedream Integrations

Added new integrations with Pipedream, enhancing the platform's connectivity. [PR #1435](https://github.com/latitude-dev/latitude-llm/pull/1435)

## Dependency Updates

- Bumped `@t3-oss/env-core` from 0.10.1 to 0.13.8. [PR #1440](https://github.com/latitude-dev/latitude-llm/pull/1440)
- Bumped `@next/eslint-plugin-next` from 14.2.29 to 15.3.4. [PR #1437](https://github.com/latitude-dev/latitude-llm/pull/1437)
- Bumped `@typescript-eslint/eslint-plugin` from 7.18.0 to 8.33.1. [PR #1370](https://github.com/latitude-dev/latitude-llm/pull/1370)
- Bumped `next` from 15.3.3 to 15.3.4. [PR #1428](https://github.com/latitude-dev/latitude-llm/pull/1428)

## Telemetry Instrumentation

The backend was instrumented with telemetry to improve observability. [PR #1422](https://github.com/latitude-dev/latitude-llm/pull/1422)

## CLI Feature

Implemented a CLI for easier interaction with Latitude projects from the terminal. [PR #1413](https://github.com/latitude-dev/latitude-llm/pull/1413)

## Refactor

Improved request parameter typing in the Typescript SDK for better type safety. [PR #1416](https://github.com/latitude-dev/latitude-llm/pull/1416)

## Create Log Method

Reintroduced the create log method to enhance logging capabilities. [PR #1423](https://github.com/latitude-dev/latitude-llm/pull/1423)
