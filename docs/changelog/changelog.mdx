...
## Evaluations V2 Refiner

- Added Evaluations V2 to the Prompt Refiner, enhancing the platform's evaluation capabilities.
- [Commit 125ee95](https://github.com/latitude-dev/latitude-llm/commit/125ee954cdf6145e479e8e4e050a71cffb44b3c7)
- [PR #1104](https://github.com/latitude-dev/latitude-llm/pull/1104)

## Documents Queue/Worker

- Introduced a queue and worker with higher concurrency for faster document processing, enhancing performance for I/O bound tasks.
- [Commit 927b477](https://github.com/latitude-dev/latitude-llm/commit/927b47760586704e30386314a2d26967840feb07)
- [PR #1100](https://github.com/latitude-dev/latitude-llm/pull/1100)

## Experiments Schema

- Implemented a new schema for experiments, impacting how experiments are structured and managed.
- [Commit 74dd315](https://github.com/latitude-dev/latitude-llm/commit/74dd315bd70ae30d71db35017e4ec7a637f3ade1)
- [PR #1095](https://github.com/latitude-dev/latitude-llm/pull/1095)

## Impersonate Feature for Admin Users

- Added a feature allowing admin users to impersonate others, likely for testing or support purposes.
- [Commit 2f47d07](https://github.com/latitude-dev/latitude-llm/commit/2f47d0748d7ab1e1359bc6a98dbaada5e449783b)

## Improved Stream Error Handling in SDK

- Enhanced error handling in the SDK to prevent silent failures, improving reliability.
- [Commit 540b247](https://github.com/latitude-dev/latitude-llm/commit/540b24753b6eddba633be80acacc7ae2b9b9cc94)
