...
We've added a new evaluation metric called "Numeric similarity". This metric
allows you to compare the numeric values of two responses and determine how
similar they are. The metric is based on the [cosine
similarity](https://en.wikipedia.org/wiki/Cosine_similarity) between the two
vectors.
