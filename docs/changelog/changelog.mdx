...
- [PR #1456](https://github.com/latitude-dev/latitude-llm/pull/1456)

## Pipedream Triggers
- Introduces integration triggers with new database models, webhook handlers, and UI components for managing Pipedream's Dynamic Forms.
- [PR #1454](https://github.com/latitude-dev/latitude-llm/pull/1454)

## Implement Blocks Editor Update Cycle
- Connects text, AST, blocks, and Lexical Editor for a seamless update cycle.
- [PR #1444](https://github.com/latitude-dev/latitude-llm/pull/1444)

## Dependency Updates
- Bumps `cron-parser` from 5.0.4 to 5.3.0.
- Bumps `@ai-sdk/google-vertex` from 2.1.12 to 2.2.27.
- Bumps `zustand` from 4.5.6 to 5.0.5.

## Ingest Spans and Process Segments
- Related to issue #1273, this PR focuses on ingesting spans and processing segments.
- [PR #1436](https://github.com/latitude-dev/latitude-llm/pull/1436)

## Implement SDK Method and Gateway Endpoint for Getting Project by ID
- Adds functionality to retrieve a project by its ID with a new API endpoint and SDK method.
- [PR #1420](https://github.com/latitude-dev/latitude-llm/pull/1420)

## Feature/Local Sync
- Introduces local synchronization features.
- [PR #1403](https://github.com/latitude-dev/latitude-llm/pull/1403)
