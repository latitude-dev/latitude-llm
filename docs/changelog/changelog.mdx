...
## feat: cli
Implemented a CLI for Latitude, allowing users to interact with their projects from the terminal. Features include syncing projects, checking status, and managing versions.
...
Updated AWS SDK dependencies to the latest version.
[PR #1417](https://github.com/latitude-dev/latitude-llm/pull/1417)

## chore(deps-dev): bump @rollup/plugin-commonjs from 28.0.3 to 28.0.6
Updated Rollup plugin dependencies to fix bugs and improve stability.
[PR #1418](https://github.com/latitude-dev/latitude-llm/pull/1418)

## feature: adds sdk methods for new gateway endpoints
Added new SDK methods for managing projects and versions through the gateway.
[PR #1412](https://github.com/latitude-dev/latitude-llm/pull/1412)

## Feature/new gateway endpoints
Implemented new gateway endpoints for project and commit management.
[PR #1411](https://github.com/latitude-dev/latitude-llm/pull/1411)

## Latte: Add change feedback
Added feedback mechanism for changes in the Latte editor.
[PR #1414](https://github.com/latitude-dev/latitude-llm/pull/1414)

## Telemetry SDK changes
Made changes to the Telemetry SDK to improve observability.
[PR #1407](https://github.com/latitude-dev/latitude-llm/pull/1407)

## Smarter diff for Latte streaming
Improved the diff calculation for real-time editing in Latte.
