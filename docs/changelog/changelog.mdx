...
- **Run Linter and Fix Warnings**: Cleaned up all linter warnings to improve code quality and maintainability. [PR #1390](https://github.com/latitude-dev/latitude-llm/pull/1390)

## User Experience Enhancements
- **Add Interaction Segment and Change Document to Conversation**: Enhanced the interaction segment and changed document terminology to conversation, improving user experience. [PR #1399](https://github.com/latitude-dev/latitude-llm/pull/1399)

## Bug Fixes
- **Fix: Experiments with Custom Provider**: Addressed issues with experiments using a custom provider, ensuring better functionality. [PR #1397](https://github.com/latitude-dev/latitude-llm/pull/1397)
- **Fix Lag When Clicking on Tools (Integrations) Toggle**: Resolved lag issues when toggling tools, enhancing performance. [PR #1388](https://github.com/latitude-dev/latitude-llm/pull/1388)

## New Features
- **Latte: Threads**: Introduced model schema for Latte Threads and Checkpoints, allowing users to manage changes effectively. [PR #1391](https://github.com/latitude-dev/latitude-llm/pull/1391)
- **Project Copilot – Latte**: Introduced the first iteration of Latte, a project copilot feature for project and prompt management. [PR #1268](https://github.com/latitude-dev/latitude-llm/pull/1268)

## Performance Improvements
- **Editor Adjustments to Improve Vertical Space and Agents Visibility**: Made adjustments to improve the setup of agents and vertical space in the editor. [PR #1375](https://github.com/latitude-dev/latitude-llm/pull/1375)

## API and SDK Enhancements
- **Improve API and SDK Error Delivering**: Enhanced error delivery in the API and SDK, providing more detailed error messages. [PR #1333](https://github.com/latitude-dev/latitude-llm/pull/1333)

### Minor Updates
- **Retry Evals on Not Found Errors**: Introduced a retry mechanism for evaluations encountering "not found" errors, improving robustness.
- **Add Second Read Replica**: Added a second read replica to enhance database read performance and reliability.
