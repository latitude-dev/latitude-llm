...
- **Evaluations V2 Refiner**: Added Evaluations V2 to the Prompt Refiner, enhancing the evaluation capabilities. [PR #1104](https://github.com/latitude-dev/latitude-llm/pull/1104)
- **Documents Queue/Worker**: Introduced a queue and worker with higher concurrency for faster document processing, optimizing I/O bound tasks. [PR #1100](https://github.com/latitude-dev/latitude-llm/pull/1100)
- **Experiments Schema**: Implemented a new schema for experiments, providing a structured approach to experimental data. [PR #1095](https://github.com/latitude-dev/latitude-llm/pull/1095)
- **Stream Error Handling in SDK**: Improved error handling in the SDK, enhancing reliability and user experience. [PR #1090](https://github.com/latitude-dev/latitude-llm/pull/1090)

## Minor Updates

- **Optional Heapdump Package**: Made the heapdump package optional, allowing for more flexible configurations. [Commit 25b3f46](https://github.com/latitude-dev/latitude-llm/commit/25b3f46131e98780e43a81b13b88b041df340936)
- **Agent Optimization on Chains**: Improved agent optimization on chains, enhancing performance. [PR #1082](https://github.com/latitude-dev/latitude-llm/pull/1082)
- **Refactor Jobs**: Refactored jobs to potentially fix memory leaks, improving system stability. [PR #1086](https://github.com/latitude-dev/latitude-llm/pull/1086)
