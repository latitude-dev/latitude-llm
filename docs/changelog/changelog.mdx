...
1. **Evaluations V2 in Prompt Refiner**:
   - Introduced a new version of evaluations, enhancing the prompt refiner's capabilities.
...
2. **Documents Queue/Worker**:
   - Added a queue and worker with higher concurrency for faster document processing, optimizing I/O bound tasks.
   - [Commit](https://github.com/latitude-dev/latitude-llm/commit/927b47760586704e30386314a2d26967840feb07)

3. **Experiments Schema**:
   - Implemented a new schema for experiments, enhancing the structure and management of experimental data.
   - [Commit](https://github.com/latitude-dev/latitude-llm/commit/74dd315bd70ae30d71db35017e4ec7a637f3ade1)

4. **Improved Stream Error Handling in SDK**:
   - Enhanced error handling in the SDK to address silent failures, improving reliability and debugging.
   - [Commit](https://github.com/latitude-dev/latitude-llm/commit/540b24753b6eddba633be80acacc7ae2b9b9cc94)

5. **Parameter Mapping to Selected Dataset**:
   - Improved parameter mapping to datasets, enhancing user experience and data handling.
   - [Commit](https://github.com/latitude-dev/latitude-llm/commit/900ffd678ab53df108b550a05b387e13db02eaf9)
