...
## Instrument backend with telemetry
- Implemented telemetry instrumentation for the backend.
- [PR #1422](https://github.com/latitude-dev/latitude-llm/pull/1422)

## Feature/bring back create log method
- Reintroduced the create log method.
- [PR #1423](https://github.com/latitude-dev/latitude-llm/pull/1423)

## CLI Implementation
- Introduced a CLI for interacting with Latitude projects from the terminal.
- [PR #1413](https://github.com/latitude-dev/latitude-llm/pull/1413)

## Improved Request Parameter Typing
- Centralized URL and body parameter type definitions for improved type safety in the Typescript SDK.
- [PR #1416](https://github.com/latitude-dev/latitude-llm/pull/1416)

## Dependency Updates
- Bumped `@aws-sdk/client-bedrock-runtime` from 3.826.0 to 3.830.0.
- Bumped `@rollup/plugin-commonjs` from 28.0.3 to 28.0.6.
