...
## Initial Prompt Parameters from Document Logs

- Introduced evaluations playground with document logs parameters from the evaluated document.
- [PR #1200](https://github.com/latitude-dev/latitude-llm/pull/1200)

## Human Evaluations V2

- Frontend and backend development for Human Evaluations V2.
- [PR #1203](https://github.com/latitude-dev/latitude-llm/pull/1203)
- [PR #1195](https://github.com/latitude-dev/latitude-llm/pull/1195)

## Experiment Variants

- Users can now create multiple experiments for the same prompt at once, enabling performance comparison.
- [PR #1206](https://github.com/latitude-dev/latitude-llm/pull/1206)

## Evaluations V2 Migrations

- Migration of evaluations to version 2.
- [PR #1204](https://github.com/latitude-dev/latitude-llm/pull/1204)

## Experiments: BlankSlate & Generate Dataset Button

- Introduced BlankSlate and Generate Dataset button for experiments.
- [PR #1197](https://github.com/latitude-dev/latitude-llm/pull/1197)

## Readwise Integration

- Integration with Readwise.
- [PR #1196](https://github.com/latitude-dev/latitude-llm/pull/1196)

## Support for Agentic LLM Evaluations V2

- Support for Agentic LLM Evaluations V2.
- [PR #1185](https://github.com/latitude-dev/latitude-llm/pull/1185)

## LLM Evaluation V2 Generator

- Related to the LLM Evaluation V2 Generator.
- [PR #1176](https://github.com/latitude-dev/latitude-llm/pull/1176)

## Evaluations V2 Templates

- Related to evaluations v2 templates.
- [PR #1170](https://github.com/latitude-dev/latitude-llm/pull/1170)

### Minor Updates

- Fix: Include tool calls and agent response to documentLogCreated event.
  - [PR #1202](https://github.com/latitude-dev/latitude-llm/pull/1202)
- Fix: Parameters keeping state between input type changes.
  - [PR #1198](https://github.com/latitude-dev/latitude-llm/pull/1198)
