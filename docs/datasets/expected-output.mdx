...
- the behavior described in the signal or in an [annotation](../annotations/overview)
...
- [Simulate agents locally](../test-and-fix/simulations): drive multi-turn conversations from the same rows.
