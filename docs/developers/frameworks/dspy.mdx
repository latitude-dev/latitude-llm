...
<Check>
  You'll keep calling DSPy exactly as you do today — Telemetry simply
...
<Steps>
  ...
  <Step title="Initialize Latitude Telemetry">
    ...
    <Info>
      The Telemetry instance should only be created once. Any DSPy program
      executions after this will be automatically traced.
    </Info>
