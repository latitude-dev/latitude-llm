...
This guide shows you how to integrate **Latitude Telemetry** into an existing application that uses the official **Gemini SDK** (`google-generativeai`).
...
<Steps>
  ...
  <Step title="Initialize Latitude Telemetry">
    ...
    <Info>
      The Telemetry instance should only be created once. Any Gemini SDK
