...
<Steps>
  ...
  <Step title="Initialize Latitude Telemetry">
    ...
    You must enable the **MistralAI** instrumentor so Telemetry can trace it.
    ...
    <Info>
      The Telemetry instance should only be created once. Any Mistral AI client
  ...
  <Step title="Wrap your Mistral AI-powered feature">
    Wrap the code that calls Mistral AI using <code>telemetry.capture</code>.
