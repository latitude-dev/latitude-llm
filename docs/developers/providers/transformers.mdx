...
<Steps>
  ...
  <Step title="Initialize Latitude Telemetry">
    ...
    You must enable the **Transformers** instrumentor so Telemetry can trace it.
    ...
    <Info>
      The Telemetry instance should only be created once. Any Transformers
      pipeline calls made after this will be automatically traced.
    </Info>

  </Step>

  <Step title="Wrap your Transformers-powered feature">
    Wrap the code that calls Transformers using <code>telemetry.capture</code>.
