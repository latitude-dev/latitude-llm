---
title: Experiments
description: Compare two or more slices of your data side by side, with every metric across sessions, users, tools, signals, behaviors and more.
---
