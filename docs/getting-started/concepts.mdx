...
When you create a project, Latitude automatically provisions default flaggers that classify incoming traces against common failure categories so issue discovery has immediate value before you configure custom evaluations.
