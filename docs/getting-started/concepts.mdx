---
title: Core Concepts
description: "Understand Latitude's core concepts: projects, spans, traces, sessions, search, scores, evaluations, and signals."
---

# Core Concepts

Latitude is organized around a small set of concepts that connect production telemetry to signal discovery. A project receives agent activity as spans, traces, and sessions; search helps you find relevant traces; scores record judgments about trace quality; evaluations monitor known behaviours; and signals group repeated failures into trackable problems.
...
- signals discovered from failed scores
- evaluations and simulations
- project settings such as monitoring behaviour

<Frame>
  <img src="/images/getting-started/projects.png" alt="Projects page showing a list of projects with signals, datasets, and trace counts" />
</Frame>
...
- signals group related failed trace signals
...
An **signal** is a recurring failure pattern discovered from failed scores. Instead of leaving failures as isolated examples, Latitude groups similar failures into named signals with examples, trends, affected users, lifecycle states, and linked evaluations.
...
Signal states include **new**, **escalating**, **resolved**, **regressed**, and **ignored**. An signal can have multiple states at once, such as new and escalating.
...
- catch regressions after an signal is resolved
...
7. **Evaluations** monitor known behaviours and can be generated from important signals.
8. Failed scores cluster into **signals** that your team can triage, monitor, and fix.
...
- [Evaluations](../evaluations/overview): monitor known behaviours and signal patterns.
- [Signals](../signals/overview): understand how failed scores become signals.
