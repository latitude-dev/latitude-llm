...
<Steps>
  ...
  <Step title="Let Latitude cluster issues">
    Failed annotations, flagger matches, evaluation failures, and custom scores become [scores](../scores/overview). Latitude groups similar failed scores into [issues](../signals/overview): recurring production failure patterns with names, descriptions, examples, trends, and lifecycle states.
  </Step>
