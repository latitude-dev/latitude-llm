...
description: Understand what Latitude is, why teams use its MIT-licensed open-source platform, and how observability, search, and signals work together.
---

# Latitude Overview

Latitude is an **open-source, MIT-licensed** platform for improving production AI agents. It helps teams capture real agent traffic, find important behaviours across that traffic, and turn repeated failures into trackable signals.

The core workflow is simple: **observe what happened, search for what matters, track recurring signals, and monitor whether fixes work**.
...
Signals are recurring failure patterns discovered from failed scores. Human annotations, built-in flaggers, evaluations, and custom scores can all identify bad behaviour. Latitude groups similar failures into signals with examples, trends, affected users, lifecycle states, and linked monitors.
...
- resolve or ignore signals as part of your team workflow
...
Learn more in [Signals](../signals/overview), [Signal management](../signals/management), and [Evaluations](../evaluations/overview).
