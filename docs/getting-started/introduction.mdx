...
Learn more in [Signal Discovery](../signals/overview), [Issue Management](../signals/management), and [Evaluations](../evaluations/overview).
...
Latitude is built around **LLM signal discovery**. Observability, semantic search, annotations, flaggers, scores, and evaluations are designed to work together automatically so teams can track production agent failures with minimal manual setup.
