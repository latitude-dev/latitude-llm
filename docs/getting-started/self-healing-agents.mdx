...
<Steps>
  ...
  <Step title="Score live traffic continuously">
    Give a signal an [evaluation](../evaluations/overview), a script that can combine code rules, semantic similarity, and LLM judgment, and every new trace is scored on arrival. Evaluations generated from your annotations carry an [alignment record](../evaluations/alignment), so how often the script agrees with a human reviewer is a measured number.
  </Step>
