...
- `interactive`: Optional boolean parameter (defaults to `false`). When set to true the attached conversation will be aborted when the client disconnects.
