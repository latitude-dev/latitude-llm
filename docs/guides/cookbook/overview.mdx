...
- [Running a prompt locally with OpenAI](https://github.com/latitude-dev/latitude-llm/blob/main/examples/sdks/python/providers/with_openai.py)
- [Running a prompt locally with Anthropic](https://github.com/latitude-dev/latitude-llm/blob/main/examples/sdks/python/providers/with_anthropic.py)
