...
## Video Tutorial: Using Prompt Suggestions

See how to use the Refiner in this 2-3 minute video:

<iframe
  width='100%'
  height='500px'
  src='https://www.youtube.com/embed/EXAMPLE_ID'
  title='Using Prompt Suggestions'
  frameborder='0'
