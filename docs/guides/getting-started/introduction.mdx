...
- **Logs & Observability**: Automatically capture all interactions and monitor performance metrics
...
3. **Deploy**: Publish prompts as endpoints through the AI Gateway
...
6. **Improve**: Refine prompts based on evaluation insights

![Latitude Workflow Diagram](/assets/latitude-workflow-diagram.png)

## Platform Overview Video

Get a quick visual introduction to Latitude in this 3-minute overview:
...
Have questions or feedback? Join [our community on Slack](https://join.slack.com/t/trylatitude/shared_invite/zt-2vlnnz3xi-mO1DArzBX0lTJJBATVhR7w) to connect with other Latitude users and our team.
