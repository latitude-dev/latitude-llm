...
If you already belong to a workspace, you cannot create additional workspaces yourself. However, you can be invited to join other workspaces by their administrators. Once you belong to multiple workspaces, you can switch between them at any time using the workspace switcher in the navigation bar without logging out. Learn more about [working across multiple workspaces](/guides/getting-started/invite-your-team#working-across-multiple-workspaces).
