...
2.  Thoroughly test the draft in the [Playground](/guides/prompt-manager/playground) and potentially using [batch evaluations](/guides/evaluations/running-evaluations#running-evaluations-on-datasets-batch-mode).
...
- Look for the API endpoint URL or integration instructions, often displayed near the prompt title or in a dedicated "Integration" tab/section.
