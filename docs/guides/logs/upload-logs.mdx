...
![Upload logs](/images/guides/logs/upload_logs_1.png)
...
<Note>
  Logs follow OpenAI's [format](https://platform.openai.com/docs/guides/text-generation/building-prompts).
...
To evaluate your uploaded logs, make sure to first create and connect an evaluation to your prompt. Also, make sure the evaluation is configured to [evaluate live logs](/guides/evaluations/running-evaluations).
...
You can push logs to Latitude with Latitude's SDK. Check out Latitude' SDK [`log` method](/guides/sdk/javascript-typescript-sdk).
