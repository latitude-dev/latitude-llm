...
To evaluate your uploaded logs, make sure to first create and connect an evaluation to your prompt. Also, make sure the evaluation is configured to [evaluate live logs](/guides/evaluations/running-evaluations#running-evaluations-in-live-mode).
