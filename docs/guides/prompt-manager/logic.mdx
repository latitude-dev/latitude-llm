...
You can use the response from a previous step in your conditions. First, save the step response to a variable:

```
    <step as="variable_response">Is the user a premium member?</step>
