...
We provide a custom docker profile for building your own images locally. To build your own local images, run the following command:

```bash
docker compose --profile local build
```

To run your local images, run the following command:
