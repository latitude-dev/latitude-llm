...
<Columns cols={3}>
  <Card
    title='OpenAI'
    icon='openai'
    href='/integrations/providers/openai'
    arrow='true'
  />
  <Card
    title='Anthropic'
    href='/integrations/providers/anthropic'
    arrow='true'
    icon={
      <svg
  ...
  <Card
    ...
    href='/integrations/providers/amazon-bedrock'
    arrow='true'
    icon='aws'
  />
  <Card
    title='Azure'
    href='/integrations/providers/azure'
    arrow='true'
    icon='microsoft'
  />
  <Card
  ...
  <Card
    title='Cohere'
    href='/integrations/providers/cohere'
    arrow='true'
    icon={
      <svg
        xmlns='http://www.w3.org/2000/svg'
  ...
  <Card
    title='Together AI'
    href='/integrations/providers/together-ai'
    arrow='true'
    icon={
      <svg
        xmlns='http://www.w3.org/2000/svg'
