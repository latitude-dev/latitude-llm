...
Click any issue to open its detail page:

{/* TODO: re-capture issue-detail.png, this is now the full issue page, not the old drawer. */}

<Frame>
  <img
    src="/images/issues/issue-detail.png"
    alt="Issue detail page showing impact, status, trend, patterns, examples, linked evaluations, and trace logs"
  />
</Frame>

The issue page shows the issue description, lifecycle state, impact (affected traces, sessions, users, and cost), assignee and priority, a trend chart, recurring patterns, linked evaluations, an examples carousel, and the recent traces where the issue was detected. Open example traces to understand what triggered the issue and what the agent did wrong.
