...
System monitors are **locked**: you can't change their name, alerts, or severities. The single tunable value is the **Signal escalating** sensitivity.
...
- [Signals](../signals/overview): what the system monitors watch
