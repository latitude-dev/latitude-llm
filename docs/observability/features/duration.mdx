...
Duration pairs well with semantic search. For example, search for _agent loops between tools_ and filter to high-duration traces to find slow looping behaviors.
...
- [Search](../../search/overview): Combine duration filters with behavioral search
