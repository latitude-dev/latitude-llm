...
Add release and version context through tags or metadata to investigate whether a behavior started after a deploy, compare canary and stable traffic, or filter signal examples to one agent version.
...
- search for behaviors introduced by a release
...
- [Search](../../search/overview): Discover version-specific behaviors
