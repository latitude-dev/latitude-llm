...
- for discovery-owned failures, the `issue-discovery` workflow runs `syncScoreAnalyticsUseCase` as a dedicated post-transaction activity after `createOrAssignIssueUseCase`
