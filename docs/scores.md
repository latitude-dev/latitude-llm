...
- human-editable draft finalization is driven by persisted due-work scans plus the `score-draft-finalization` background task rather than browser-local timers or BullMQ delayed jobs
