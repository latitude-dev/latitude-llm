...
Search lives on the **Traces** page. Use the search bar to find behaviors across production traces by meaning, exact text, or both, then narrow results with filters.
...
Search is the discovery layer for behaviors Latitude should track. A typical workflow is:

1. Search for a user or agent behavior you care about.
...
| --- | --- |
| **[Saved searches](./saved-searches)** | Revisit useful behavioral cohorts |
| **[Inline annotations](../annotations/inline-annotations)** | Label traces from search as good or bad behavior |
...
- [Saved Searches](./saved-searches): Save behavioral cohorts for repeated review
