...
If you are exploring rather than tracking something specific, start with [Search](../search/overview) and [Behaviors](../behaviours/overview) instead, and let discovery surface patterns.
