...
5. Evaluations run locally against the captured traces
...
- The `issues` selector downloads all issue-linked evaluations and runs them locally.
...
When you provide a Latitude API key, simulation results can be uploaded to your project. This gives you historical tracking, trace inspection in the Latitude UI, and score integration with your project's analytics.
...
- [Evaluations](../evaluations/overview): The evaluations simulations use
