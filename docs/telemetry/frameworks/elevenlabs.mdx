  ...
  <Step title="Install">
    <Tabs>
      ...
      <Tab title="TypeScript">
        <CodeGroup>
          ```bash npm
          npm install @latitude-data/telemetry openai express @traceloop/instrumentation-openai
          ```

          ```bash pnpm
          pnpm add @latitude-data/telemetry openai express @traceloop/instrumentation-openai
          ```

          ```bash yarn
          yarn add @latitude-data/telemetry openai express @traceloop/instrumentation-openai
          ```
        </CodeGroup>
      </Tab>
    </Tabs>
