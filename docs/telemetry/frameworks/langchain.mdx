  ...
  <Step title="Install">
    <Tabs>
      <Tab title="TypeScript">
        <CodeGroup>
          ```bash npm
          npm install @latitude-data/telemetry @arizeai/openinference-instrumentation-langchain langchain @langchain/openai @langchain/core
          ```

          ```bash pnpm
          pnpm add @latitude-data/telemetry @arizeai/openinference-instrumentation-langchain langchain @langchain/openai @langchain/core
          ```

          ```bash yarn
          yarn add @latitude-data/telemetry @arizeai/openinference-instrumentation-langchain langchain @langchain/openai @langchain/core
          ```

          ```bash bun
          bun add @latitude-data/telemetry @arizeai/openinference-instrumentation-langchain langchain @langchain/openai @langchain/core
          ```
        </CodeGroup>
      </Tab>
      <Tab title="Python">
