  ...
  <Step title="Install">
    <Tabs>
      <Tab title="TypeScript">
        <CodeGroup>
          ```bash npm
          npm install @latitude-data/telemetry @arizeai/openinference-instrumentation-langchain
          ```

          ```bash pnpm
          pnpm add @latitude-data/telemetry @arizeai/openinference-instrumentation-langchain
          ```

          ```bash yarn
          yarn add @latitude-data/telemetry @arizeai/openinference-instrumentation-langchain
          ```

          ```bash bun
          bun add @latitude-data/telemetry @arizeai/openinference-instrumentation-langchain
          ```
        </CodeGroup>
      </Tab>
      <Tab title="Python">
