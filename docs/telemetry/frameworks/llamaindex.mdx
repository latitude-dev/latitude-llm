  ...
  <Step title="Install">
    <Tabs>
      <Tab title="TypeScript">
        <CodeGroup>
          ```bash npm
          npm install @latitude-data/telemetry @traceloop/instrumentation-llamaindex
          ```

          ```bash pnpm
          pnpm add @latitude-data/telemetry @traceloop/instrumentation-llamaindex
          ```

          ```bash yarn
          yarn add @latitude-data/telemetry @traceloop/instrumentation-llamaindex
          ```

          ```bash bun
          bun add @latitude-data/telemetry @traceloop/instrumentation-llamaindex
          ```
        </CodeGroup>
      </Tab>
      <Tab title="Python">
