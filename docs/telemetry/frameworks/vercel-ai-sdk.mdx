...
<Steps>
  ...
  <Step title="Initialize and use">
    ...
    <Note>
      `latitude.getAiSdkTelemetry()` enables AI SDK telemetry and passes a Latitude-owned tracer.
      This keeps traces flowing even in runtimes that already registered a global OpenTelemetry
      provider that Latitude cannot attach to.
    </Note>
  </Step>
