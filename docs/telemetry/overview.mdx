...
| [OpenAI Agents SDK](frameworks/openai-agents) | `"openai-agents"` | `@openai/agents` | `openai-agents` |
...
| [Mastra](frameworks/mastra) | - | `@mastra/core` | - |

## Next Steps

- **SDK Reference**: [TypeScript SDK](typescript) · [Python SDK](python)
- **Other languages**: [OTLP Exporter](otel-exporter) — connect from Go, Java, Ruby, .NET, or any OpenTelemetry-supported language
