  ...
  <Step title="Install">
    <Tabs>
      <Tab title="TypeScript">
        <CodeGroup>
          ```bash npm
          npm install @latitude-data/telemetry @traceloop/instrumentation-together
          ```

          ```bash pnpm
          pnpm add @latitude-data/telemetry @traceloop/instrumentation-together
          ```

          ```bash yarn
          yarn add @latitude-data/telemetry @traceloop/instrumentation-together
          ```

          ```bash bun
          bun add @latitude-data/telemetry @traceloop/instrumentation-together
          ```
        </CodeGroup>
      </Tab>
      <Tab title="Python">
