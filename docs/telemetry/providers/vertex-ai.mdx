  ...
  <Step title="Install">
    <Tabs>
      <Tab title="TypeScript">
        <CodeGroup>
          ```bash npm
          npm install @latitude-data/telemetry @traceloop/instrumentation-vertexai
          ```

          ```bash pnpm
          pnpm add @latitude-data/telemetry @traceloop/instrumentation-vertexai
          ```

          ```bash yarn
          yarn add @latitude-data/telemetry @traceloop/instrumentation-vertexai
          ```

          ```bash bun
          bun add @latitude-data/telemetry @traceloop/instrumentation-vertexai
          ```
        </CodeGroup>
      </Tab>
      <Tab title="Python">
