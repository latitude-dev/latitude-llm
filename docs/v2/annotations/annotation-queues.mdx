...
| **Instructions** | Guidance for annotators reviewing traces in this queue — helps reviewers understand what to look for and how to assess interactions |
...
- **Filters** — Define which traces should enter the queue using the [shared filter system](../observability/filters)
