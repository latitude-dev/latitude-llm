...
| **Score** | A quantitative verdict on a trace, span, or session — normalized between 0 and 1 |
...
| **Annotation** | A human-reviewed score, created through Latitude's annotation workflow or your own UI |
