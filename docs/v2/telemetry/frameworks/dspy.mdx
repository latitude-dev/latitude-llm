---
title: DSPy
description: Connect your DSPy-based application to Latitude Telemetry for observability in Latitude V2.
---
...
- Every DSPy program execution will appear as a trace in Latitude.
- Traces are grouped inside a Latitude **project** and identified by a `path`.
- You can inspect inputs/outputs, measure latency, score, and debug DSPy-powered features from the Latitude dashboard.
...
<Steps>
  ...
  <Step title="Wrap your DSPy-powered feature">
    Initialize Latitude Telemetry and wrap the code that runs DSPy programs using <code>telemetry.capture</code>.
...
Each DSPy program execution appears as a child span under the capture, giving you a full view of what happened.
