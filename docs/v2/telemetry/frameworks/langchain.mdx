---
title: LangChain
description: Connect your LangChain-based application to Latitude Telemetry for observability in Latitude V2.
---
...
- Every LangChain call (e.g. `invoke`) will appear as a trace in Latitude.
- Traces are grouped inside a Latitude **project** and identified by a `path`.
- You can inspect inputs/outputs, measure latency, score, and debug LangChain-powered features from the Latitude dashboard.
...
<Steps>
  ...
  <Step title="Wrap your LangChain-powered feature">
    Initialize Latitude Telemetry and wrap the code that calls LangChain using <code>telemetry.capture</code>.
...
Each LangChain call appears as a child span under the capture, giving you a full view of what happened.
