---
title: LlamaIndex
description: Connect your LlamaIndex-based application to Latitude Telemetry for observability in Latitude V2.
---
...
- Every LlamaIndex call (e.g. `query`) will appear as a trace in Latitude.
- Traces are grouped inside a Latitude **project** and identified by a `path`.
- You can inspect inputs/outputs, measure latency, score, and debug LlamaIndex-powered features from the Latitude dashboard.
...
Each LlamaIndex call appears as a child span under the capture, giving you a full view of what happened.
