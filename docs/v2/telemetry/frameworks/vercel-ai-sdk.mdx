---
title: Vercel AI SDK
description: Connect your Vercel AI SDK-powered application to Latitude Telemetry for observability in Latitude V2.
---
...
- Every Vercel AI SDK call (e.g. `generateText`) will appear as a trace in Latitude.
- Traces are grouped inside a Latitude **project** and identified by a `path`.
- You can inspect inputs/outputs, measure latency, score, and debug Vercel AI SDK-powered features from the Latitude dashboard.
...
Each Vercel AI SDK call appears as a child span under the capture, giving you a full view of what happened.
