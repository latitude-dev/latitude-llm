---
title: Aleph Alpha
description: Connect your Aleph Alpha-powered application to Latitude Telemetry for observability in Latitude V2.
---
...
- Every Aleph Alpha call (e.g. `complete`) will appear as a trace in Latitude.
- Traces are grouped inside a Latitude **project** and identified by a `path`.
- You can inspect inputs/outputs, measure latency, score, and debug Aleph Alpha-powered features from the Latitude dashboard.
...
<Steps>
  ...
  <Step title="Wrap your Aleph Alpha-powered feature">
    Initialize Latitude Telemetry and wrap the code that calls Aleph Alpha using <code>telemetry.capture</code>.
...
Each Aleph Alpha call appears as a child span under the capture, giving you a full view of what happened.
