---
title: Anthropic
description: Connect your Anthropic-powered application to Latitude Telemetry for observability in Latitude V2.
---
...
- Every Anthropic call (e.g. `messages.create`) will appear as a trace in Latitude.
- Traces are grouped inside a Latitude **project** and identified by a `path`.
- You can inspect inputs/outputs, measure latency, score, and debug Anthropic-powered features from the Latitude dashboard.
...
Each Anthropic call appears as a child span under the capture, giving you a full view of what happened.
