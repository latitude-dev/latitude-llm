---
title: Azure
description: Connect your Azure-powered application to Latitude Telemetry for observability in Latitude V2.
---
...
- Every Azure OpenAI call (e.g. `chat.completions.create`) will appear as a trace in Latitude.
- Traces are grouped inside a Latitude **project** and identified by a `path`.
- You can inspect inputs/outputs, measure latency, score, and debug Azure OpenAI-powered features from the Latitude dashboard.
...
Each Azure OpenAI call appears as a child span under the capture, giving you a full view of what happened.
