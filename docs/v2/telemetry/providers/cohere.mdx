---
title: Cohere
description: Connect your Cohere-powered application to Latitude Telemetry for observability in Latitude V2.
---
...
- Every Cohere call (e.g. `generate`) will appear as a trace in Latitude.
- Traces are grouped inside a Latitude **project** and identified by a `path`.
- You can inspect inputs/outputs, measure latency, score, and debug Cohere-powered features from the Latitude dashboard.
...
Each Cohere call appears as a child span under the capture, giving you a full view of what happened.
