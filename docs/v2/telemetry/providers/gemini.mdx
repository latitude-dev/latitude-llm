---
title: Gemini
description: Connect your Gemini-powered application to Latitude Telemetry for observability in Latitude V2.
---
...
- Every Gemini call (e.g. `generate_content`) will appear as a trace in Latitude.
- Traces are grouped inside a Latitude **project** and identified by a `path`.
- You can inspect inputs/outputs, measure latency, score, and debug your Gemini-powered features from the Latitude dashboard.
...
Each Gemini call appears as a child span under the capture, giving you a full view of what happened.
