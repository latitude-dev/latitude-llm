...
description: Connect your Google AI Platform-powered application to Latitude Telemetry for observability in Latitude V2.
---
...
- Every Google AI Platform call (e.g. `predict`) will appear as a trace in Latitude.
- Traces are grouped inside a Latitude **project** and identified by a `path`.
- You can inspect inputs/outputs, measure latency, score, and debug Google AI Platform-powered features from the Latitude dashboard.
...
<Steps>
  ...
  <Step title="Wrap your Google AI Platform-powered feature">
    Initialize Latitude Telemetry and wrap the code that calls Google AI Platform using <code>telemetry.capture</code>.
...
Each Google AI Platform call appears as a child span under the capture, giving you a full view of what happened.
