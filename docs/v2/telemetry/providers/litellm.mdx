---
title: LiteLLM
description: Connect your LiteLLM-powered application to Latitude Telemetry for observability in Latitude V2.
---
...
- Every LiteLLM call (e.g. `completion`, `acompletion`) will appear as a trace in Latitude.
- Traces are grouped inside a Latitude **project** and identified by a `path`.
- You can inspect inputs/outputs, measure latency, score, and debug LiteLLM-powered features from the Latitude dashboard.
...
<Steps>
  ...
  <Step title="Wrap your LiteLLM-powered feature">
    Initialize Latitude Telemetry and wrap the code that calls LiteLLM using <code>telemetry.capture</code>.
...
Each LiteLLM call appears as a child span under the capture, giving you a full view of what happened.
