---
title: Mistral AI
description: Connect your Mistral AI-powered application to Latitude Telemetry for observability in Latitude V2.
---
...
- Every Mistral AI call (e.g. `chat.complete`) will appear as a trace in Latitude.
- Traces are grouped inside a Latitude **project** and identified by a `path`.
- You can inspect inputs/outputs, measure latency, score, and debug Mistral AI-powered features from the Latitude dashboard.
...
Each Mistral AI call appears as a child span under the capture, giving you a full view of what happened.
