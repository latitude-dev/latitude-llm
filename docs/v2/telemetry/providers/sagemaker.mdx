---
title: AWS SageMaker
description: Connect your AWS SageMaker-powered application to Latitude Telemetry for observability in Latitude V2.
---
...
- Every SageMaker call (e.g. `invoke_endpoint`) will appear as a trace in Latitude.
- Traces are grouped inside a Latitude **project** and identified by a `path`.
- You can inspect inputs/outputs, measure latency, score, and debug SageMaker-powered features from the Latitude dashboard.
...
Each SageMaker call appears as a child span under the capture, giving you a full view of what happened.
