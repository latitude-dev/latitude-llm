---
title: Together AI
description: Connect your Together AI-powered application to Latitude Telemetry for observability in Latitude V2.
---
...
- Every Together AI call (e.g. `generate`) will appear as a trace in Latitude.
- Traces are grouped inside a Latitude **project** and identified by a `path`.
- You can inspect inputs/outputs, measure latency, score, and debug Together AI-powered features from the Latitude dashboard.
...
<Steps>
  ...
  <Step title="Wrap your Together AI-powered feature">
    Initialize Latitude Telemetry and wrap the code that calls Together AI using <code>telemetry.capture</code>.
...
Each Together AI call appears as a child span under the capture, giving you a full view of what happened.
