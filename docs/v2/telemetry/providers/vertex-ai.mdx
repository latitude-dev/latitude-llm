---
title: Vertex AI
description: Connect your Google Vertex AI-powered application to Latitude Telemetry for observability in Latitude V2.
---
...
- Every Google Vertex AI call (e.g. `generateContent`) will appear as a trace in Latitude.
- Traces are grouped inside a Latitude **project** and identified by a `path`.
- You can inspect inputs/outputs, measure latency, score, and debug Google Vertex AI-powered features from the Latitude dashboard.
...
Each Google Vertex AI call appears as a child span under the capture, giving you a full view of what happened.
