...
description: Connect your IBM watsonx.ai-powered application to Latitude Telemetry for observability in Latitude V2.
---
...
- Every watsonx.ai call (e.g. `generate`, `generate_text`) will appear as a trace in Latitude.
- Traces are grouped inside a Latitude **project** and identified by a `path`.
- You can inspect inputs/outputs, measure latency, score, and debug watsonx.ai-powered features from the Latitude dashboard.
...
Each watsonx.ai call appears as a child span under the capture, giving you a full view of what happened.
