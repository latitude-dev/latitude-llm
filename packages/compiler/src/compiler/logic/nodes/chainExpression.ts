 ...
 */
export async function resolve({ node, ...props }: ResolveNodeProps<ChainExpression>) {
...
export function updateScopeContext({ node, ...props }: UpdateScopeContextProps<ChainExpression>) {
