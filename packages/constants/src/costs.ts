...
export function emptyTokenCostEntry(): TokenCostEntry {
  return { tokens: 0, cost: undefined }
}

export function emptyModelCostEntry(): ModelCostEntry {
  return {
    input: {
      prompt: emptyTokenCostEntry(),
      cached: emptyTokenCostEntry(),
    },
    output: {
      reasoning: emptyTokenCostEntry(),
      completion: emptyTokenCostEntry(),
    },
  }
}
