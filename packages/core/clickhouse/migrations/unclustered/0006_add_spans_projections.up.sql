...
ALTER TABLE spans MATERIALIZE PROJECTION proj_spans_document_commit_started_at;
ALTER TABLE spans MATERIALIZE PROJECTION proj_spans_project_started_at;
ALTER TABLE spans MATERIALIZE PROJECTION proj_spans_document_log_started_at;
