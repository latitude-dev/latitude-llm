...
DO $$ BEGIN
 CREATE TYPE "latitude"."span_metadata_types" AS ENUM('default', 'generation');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "latitude"."spans" (
	...
	"events" jsonb,
	"links" jsonb,
	"metadata_type" "latitude"."span_metadata_types" NOT NULL,
...
CREATE INDEX IF NOT EXISTS "spans_metadata_idx" ON "latitude"."spans" USING btree ("metadata_id","metadata_type");