...
ALTER TABLE "latitude"."segments" ADD CONSTRAINT "segments_log_uuid_document_logs_uuid_fk" FOREIGN KEY ("log_uuid") REFERENCES "latitude"."document_logs"("uuid") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "segments_trace_id_id_idx" ON "latitude"."segments" USING btree ("trace_id","id");--> statement-breakpoint
...
CREATE INDEX "segments_log_uuid_idx" ON "latitude"."segments" USING btree ("log_uuid");--> statement-breakpoint
...
CREATE INDEX "segments_started_at_brin_idx" ON "latitude"."segments" USING brin ("started_at") WITH (pages_per_range=32,autosummarize=true);