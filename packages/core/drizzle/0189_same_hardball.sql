...
CREATE TYPE "latitude"."log_source" AS ENUM('api', 'agent_as_tool', 'copilot', 'email_trigger', 'evaluation', 'experiment', 'playground', 'scheduled_trigger', 'shared_prompt', 'user');--> statement-breakpoint
