CREATE TABLE "latitude"."trigger_events" (
...
ALTER TABLE "latitude"."trigger_events" ADD CONSTRAINT "trigger_events_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "latitude"."workspaces"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "latitude"."trigger_events" ADD CONSTRAINT "trigger_events_commit_id_commits_id_fk" FOREIGN KEY ("commit_id") REFERENCES "latitude"."commits"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "latitude"."trigger_events" ADD CONSTRAINT "trigger_events_document_log_uuid_document_logs_uuid_fk" FOREIGN KEY ("document_log_uuid") REFERENCES "latitude"."document_logs"("uuid") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "trigger_events_workspace_idx" ON "latitude"."trigger_events" USING btree ("workspace_id");--> statement-breakpoint
CREATE INDEX "trigger_events_trigger_uuid_idx" ON "latitude"."trigger_events" USING btree ("trigger_uuid");--> statement-breakpoint
CREATE INDEX "trigger_events_document_log_uuid_idx" ON "latitude"."trigger_events" USING btree ("document_log_uuid");--> statement-breakpoint
