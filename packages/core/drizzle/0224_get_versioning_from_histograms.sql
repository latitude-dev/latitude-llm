...
ALTER TABLE "latitude"."issue_histograms" ADD CONSTRAINT "issue_histograms_commit_id_commits_id_fk" FOREIGN KEY ("commit_id") REFERENCES "latitude"."commits"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
