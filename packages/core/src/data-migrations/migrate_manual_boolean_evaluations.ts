          ...
          : await createEvaluationV2(
              {
                ...
                settings: {
                  ...
                  configuration: {
                    criteria:
                      'Describe the criteria evaluators should follow to properly perform this evaluation.',
                    passDescription:
                      evval.configuration.trueValueDescription ||
                      'Describe what the pass criteria implies.',
                    failDescription:
                      evval.configuration.falseValueDescription ||
                      'Describe what the fail criteria implies.',
                    reverseScale: false,
                  },
                },
              },
