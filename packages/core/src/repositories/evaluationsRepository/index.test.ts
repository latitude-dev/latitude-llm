...
describe('EvaluationRepository', () => {
  it('returns EvaluationDto for all evaluation types', async () => {
    ...
    expect(legacyEvals[0]!.metadata).toEqual(metadataLlmAsJudgeLegacy[0]!)
    ...
    expect(booleanEvals[0]!.metadata).toEqual(metadataLlmAsJudgeBoolean[0]!)
    ...
    expect(numericalEvals[0]!.metadata).toEqual(metadataLlmAsJudgeNumerical[0]!)
    ...
    expect(customEvals[0]!.metadata).toEqual(metadataLlmAsJudgeCustom[0]!)
  })
})
