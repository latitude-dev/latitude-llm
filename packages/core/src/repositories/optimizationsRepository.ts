...
export class OptimizationsRepository extends Repository<Optimization> {
  ...
  private async getDetailedCommits(optimizations: Optimization[]) {
  ...
  private async getDetailedDocuments(optimizations: Optimization[]) {
  ...
  private async getDetailedEvaluations(optimizations: Optimization[]) {
  ...
  private async getDetailedDatasets(optimizations: Optimization[]) {
    ...
    const datasetIds = [
      ...new Set(
        optimizations
          ...
          .map((o) => o.trainsetId!)
          .concat(
            optimizations.filter((o) => o.testsetId).map((o) => o.testsetId!),
          ),
      ),
    ]
  ...
  private async getDetailedExperiments(optimizations: Optimization[]) {
  ...
  private async withDetails(optimizations: Optimization[]) {
    ...
    const [commits, documents, evaluations, datasets, experiments] =
      await Promise.all([
        this.getDetailedCommits(optimizations),
        this.getDetailedDocuments(optimizations),
        this.getDetailedEvaluations(optimizations),
        this.getDetailedDatasets(optimizations),
        this.getDetailedExperiments(optimizations),
      ])
