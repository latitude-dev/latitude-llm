...
import type { EvaluationResultConfiguration } from '../types'

// NOTE: Deprecated
export const evaluationAdvancedTemplates = latitudeSchema.table('evaluations_templates', {
  ...
  configuration: jsonb('configuration').notNull().$type<EvaluationResultConfiguration>(),
