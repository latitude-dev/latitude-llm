...
export function isValidPropType(propType: string, value: any): boolean {
  ...
  switch (propType) {
    ...
    case 'any':
      return true // 'any' type accepts anything
    ...
    // Airtable-specific types - typically strings (IDs)
    ...
    default:
      // For unknown types, don't be permissive and log a warning
      console.warn(`Unknown Pipedream prop type: ${propType}`) //TODO - Try sentry warning logs
      return false
  }
}
