...
export async function getTriggerResponse(
  ...
  const parameters = {
    ...(trigger.configuration.senderParameter && {
      [trigger.configuration.senderParameter]: sender,
    }),
    ...(trigger.configuration.subjectParameter && {
      [trigger.configuration.subjectParameter]: subject,
    }),
    ...(trigger.configuration.contentParameter && {
      [trigger.configuration.contentParameter]: body,
    }),
  }
