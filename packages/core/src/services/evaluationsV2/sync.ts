...
type CompositeTarget = EvaluationV2<EvaluationType.Composite>
...
>(
  ...
  return await transaction.call(async (tx) => {
    ...
    await tx
      ...
      .set({ mainEvaluationUuid: newComposite.uuid })
      .where(
        and(
...
>(
  ...
  return Result.ok(updating.value.evaluation as CompositeTarget)
}
