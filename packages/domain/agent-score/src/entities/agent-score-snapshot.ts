...
import { z } from "zod"
import { agentScoreExplanationSchema } from "./agent-score-explanation.ts"
...
/** One immutable daily score and the evidence used to publish it. */
export const agentScoreSnapshotSchema = z.object({
  ...
  explanation: agentScoreExplanationSchema.optional(),
  createdAt: z.date(),
})
