...
import { SignalRegressedEmail } from "./EmailTemplate.tsx"

const loadError = (cause: unknown) => ({
  _tag: "RenderNotificationEmailError" as const,
  message: "Failed to load signal.regressed email data",
  cause,
})
  ...
  Effect.gen(function* () {
    ...
    const html = yield* Effect.tryPromise({
      try: () =>
        ...
        _tag: "RenderNotificationEmailError" as const,
        message: "Failed to render signal.regressed email",
        cause,
      }),
    })
...
export default SignalRegressedEmail
