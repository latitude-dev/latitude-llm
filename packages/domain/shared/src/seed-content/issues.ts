...
const curatedIssueOccurrenceBurstRows: readonly SeedIssueOccurrenceFixture[] = [
  ...
  ...buildOccurrenceBurstRows({
    ...
    error: null,
    feedbackBase:
      "Field audit kept finding partner-installation hallucinations, but at lower daily volume than the main escalation spikes.",
    metadata: {
      importName: "field-audit",
      reviewer: "ops-compliance",
      batch: "installation-certs-q2",
      severity: "medium",
      burstLabel: "installation-ramp-2",
    },
    duration: 0,
    tokens: 0,
    cost: 0,
  ...
  ...buildOccurrenceBurstRows({
    ...
    error: null,
    feedbackBase:
      "Field audit saw another sizeable cluster of unsupported installation-certification claims near the end of the baseline window.",
    metadata: {
      importName: "field-audit",
      reviewer: "ops-compliance",
      batch: "installation-certs-q2",
      severity: "high",
      burstLabel: "installation-ramp-3",
    },
    duration: 0,
    tokens: 0,
    cost: 0,
  ...
  ...buildOccurrenceBurstRows({
    ...
    error: null,
    feedbackBase:
      "Field audit is now seeing a same-day surge of fabricated certified-installation promises, pushing the issue into escalation.",
    metadata: {
      importName: "field-audit",
      reviewer: "ops-compliance",
      batch: "installation-certs-q2",
      severity: "critical",
      burstLabel: "installation-recent-escalation",
    },
    duration: 0,
    tokens: 0,
    cost: 0,
