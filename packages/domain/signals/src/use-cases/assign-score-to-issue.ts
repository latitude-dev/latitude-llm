...
import { type CacheError, SignalId, ProjectId, type RepositoryError, ScoreId, SqlClient } from "@domain/shared"
...
import { SignalNotFoundForAssignmentError, ScoreAlreadyOwnedBySignalError } from "../errors.ts"
