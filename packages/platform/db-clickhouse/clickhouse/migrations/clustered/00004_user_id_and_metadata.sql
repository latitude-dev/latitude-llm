...
ALTER TABLE spans ON CLUSTER default DROP INDEX IF EXISTS idx_user_id;
ALTER TABLE spans ON CLUSTER default DROP COLUMN IF EXISTS metadata;
ALTER TABLE spans ON CLUSTER default DROP COLUMN IF EXISTS user_id;

ALTER TABLE traces ON CLUSTER default DROP COLUMN IF EXISTS system_instructions;
ALTER TABLE traces ON CLUSTER default DROP COLUMN IF EXISTS last_input_messages;
ALTER TABLE traces ON CLUSTER default DROP COLUMN IF EXISTS metadata;
ALTER TABLE traces ON CLUSTER default DROP COLUMN IF EXISTS user_id;
ALTER TABLE traces ON CLUSTER default DROP COLUMN IF EXISTS session_id;
