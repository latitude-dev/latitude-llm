...
CREATE TABLE IF NOT EXISTS flagger_jev_preclassifier_observations ON CLUSTER default
(
    ...
    classify_added        Bool                            CODEC(T64, LZ4),
...
ENGINE = ReplicatedReplacingMergeTree(activity_attempt)
...
DROP TABLE IF EXISTS flagger_jev_preclassifier_observations ON CLUSTER default;
