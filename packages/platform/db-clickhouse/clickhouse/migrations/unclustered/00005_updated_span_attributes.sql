...
-- Computed performance aliases (zero storage cost)
ALTER TABLE spans
...
ALTER TABLE traces DROP COLUMN IF EXISTS overall_status;
...
-- Derived TTFT duration (zero storage cost, queryable)
ALTER TABLE traces
...
ALTER TABLE traces DROP COLUMN IF EXISTS time_to_first_token_ns;
ALTER TABLE traces DROP COLUMN IF EXISTS time_of_first_token;
...
-- Revert span columns
ALTER TABLE spans DROP COLUMN IF EXISTS inter_token_latency_ns;
ALTER TABLE spans DROP COLUMN IF EXISTS tokens_per_second;
ALTER TABLE spans DROP COLUMN IF EXISTS tool_output;
ALTER TABLE spans DROP COLUMN IF EXISTS tool_input;
ALTER TABLE spans DROP COLUMN IF EXISTS tool_name;
ALTER TABLE spans DROP COLUMN IF EXISTS tool_call_id;
ALTER TABLE spans DROP COLUMN IF EXISTS is_streaming;
ALTER TABLE spans DROP COLUMN IF EXISTS time_to_first_token_ns;
