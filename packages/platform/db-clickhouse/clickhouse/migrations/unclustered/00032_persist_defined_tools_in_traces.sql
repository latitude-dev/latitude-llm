...
-- Persist defined tools on the traces rollup — same change as 00031 made to
-- sessions; see that migration for the full rationale (defined vs called
-- tools, the groupUniqArrayArray pattern, backfill interplay with 00033).
