...
CREATE TABLE IF NOT EXISTS taxonomy_view_assignments
(
...
CREATE TABLE IF NOT EXISTS taxonomy_facet_projections
(
    organization_id           LowCardinality(String) CODEC(ZSTD(1)),
    project_id                LowCardinality(String) CODEC(ZSTD(1)),
...
DROP TABLE IF EXISTS taxonomy_facet_projections;
DROP TABLE IF EXISTS taxonomy_view_assignments;
