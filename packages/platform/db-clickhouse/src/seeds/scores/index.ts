      ...
      Effect.tap(() =>
        Effect.sync(() =>
          console.log(
            ...
            } annotations, ${issueOccurrenceAnalyticsRows.length} issue occurrences, ${alignmentAnalyticsRows.length} alignment, ${simulationAnalyticsRows.length} simulation, ${uiPolishAnalyticsRows.length} UI polish demo)`,
          ),
        ),
      ),
    ),
