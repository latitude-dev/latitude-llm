...
ALTER TABLE "latitude"."taxonomy_cluster_lineage" ADD COLUMN "dimension" varchar(32) NOT NULL;--> statement-breakpoint
ALTER TABLE "latitude"."taxonomy_clusters" ADD COLUMN "dimension" varchar(32) NOT NULL;--> statement-breakpoint
...
ALTER TABLE "latitude"."taxonomy_runs" ADD COLUMN "dimension" varchar(32) NOT NULL;--> statement-breakpoint
