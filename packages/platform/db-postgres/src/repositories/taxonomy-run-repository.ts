...
const toDomainRun = (row: typeof taxonomyRuns.$inferSelect): TaxonomyRun =>
  taxonomyRunSchema.parse({
    ...
    observationsAvailable: row.observationsAvailable,
    observationsSampled: row.observationsSampled,
    sampleStrategy: row.sampleStrategy,
    sampleCap: row.sampleCap,
...
const toInsertRow = (run: TaxonomyRun): typeof taxonomyRuns.$inferInsert => ({
  ...
  observationsAvailable: run.observationsAvailable,
  observationsSampled: run.observationsSampled,
  sampleStrategy: run.sampleStrategy,
  sampleCap: run.sampleCap,
