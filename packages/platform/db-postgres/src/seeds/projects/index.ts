...
import {
  ...
  SEED_LATITUDE_ISSUE_DISCOVERY_PROJECT_ID,
  SEED_LATITUDE_ISSUE_DISCOVERY_PROJECT_NAME,
  SEED_LATITUDE_ISSUE_DISCOVERY_PROJECT_SLUG,
...
const DOGFOOD_PROJECTS: readonly { readonly id: ProjectId; readonly name: string; readonly slug: string }[] = [
  {
    id: SEED_LATITUDE_ISSUE_DISCOVERY_PROJECT_ID,
    name: SEED_LATITUDE_ISSUE_DISCOVERY_PROJECT_NAME,
    slug: SEED_LATITUDE_ISSUE_DISCOVERY_PROJECT_SLUG,
  },
  {
