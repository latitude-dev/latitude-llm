...
import {
  ...
  SEED_LATITUDE_EVALUATION_SCRIPT_GENERATION_PROJECT_ID,
  SEED_LATITUDE_EVALUATION_SCRIPT_GENERATION_PROJECT_NAME,
  SEED_LATITUDE_EVALUATION_SCRIPT_GENERATION_PROJECT_SLUG,
...
const DOGFOOD_PROJECTS: readonly { readonly id: ProjectId; readonly name: string; readonly slug: string }[] = [
  ...
  {
    id: SEED_LATITUDE_EVALUATION_SCRIPT_GENERATION_PROJECT_ID,
    name: SEED_LATITUDE_EVALUATION_SCRIPT_GENERATION_PROJECT_NAME,
    slug: SEED_LATITUDE_EVALUATION_SCRIPT_GENERATION_PROJECT_SLUG,
  },
  {
