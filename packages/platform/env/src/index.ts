...
export class MissingEnvValueError extends Data.TaggedError(
  "MissingEnvValueError",
)<{
  readonly expectedType: "string" | "number" | "boolean";
}> {}

export class InvalidEnvValueError extends Data.TaggedError(
...
export function parseEnv(
  ...
  MissingEnvValueError | InvalidEnvValueError
> {
