...
(
    ...
    `tokens_cache_create_by_ttl` Map(UInt32, UInt32) CODEC(ZSTD(1)),
    ...
    `service_tier` LowCardinality(String) DEFAULT '' CODEC(ZSTD(1)),
    `inference_geo` LowCardinality(String) DEFAULT '' CODEC(ZSTD(1)),
