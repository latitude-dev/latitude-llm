...
class CreateMonitorAlertBodyConditionThree(UniversalBaseModel):
    ...
    direction: typing.Optional[CreateMonitorAlertBodyConditionThreeDirection] = pydantic.Field(default=None)
    """
