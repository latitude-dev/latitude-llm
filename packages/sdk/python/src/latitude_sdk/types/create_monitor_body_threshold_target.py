...
from .create_monitor_body_threshold_target_metric import CreateMonitorBodyThresholdTargetMetric
...
class CreateMonitorBodyThresholdTarget(UniversalBaseModel):
    """
    Entity or filter set watched by the monitor.
    """

    type: CreateMonitorBodyThresholdTargetType = pydantic.Field()
    """
    ...
    kind: typing.Optional[CreateMonitorBodyThresholdTargetKind] = pydantic.Field(default=None)
    """
    Normalized target kind returned on persisted monitors.
    """

    stream: typing.Optional[CreateMonitorBodyThresholdTargetStream] = pydantic.Field(default=None)
    """
