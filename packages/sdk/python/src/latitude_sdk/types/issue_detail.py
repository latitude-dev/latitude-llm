...
from .issue_monitoring_state import IssueMonitoringState
from .issue_trend_bucket import IssueTrendBucket


class IssueDetail(UniversalBaseModel):
    ...
    source: IssueDetailSource = pydantic.Field()
    """
    Where the issue originated from.
    """

    states: typing.List[IssueDetailStatesItem] = pydantic.Field()
    """
    ...
    monitoring_state: typing_extensions.Annotated[IssueMonitoringState, FieldMetadata(alias="monitoringState")]
