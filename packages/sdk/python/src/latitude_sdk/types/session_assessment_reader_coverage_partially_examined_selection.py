...
class SessionAssessmentReaderCoveragePartiallyExaminedSelection(UniversalBaseModel):
    """
    Sampling details when this reader is not deterministic.
    """

    method: SessionAssessmentReaderCoveragePartiallyExaminedSelectionMethod = pydantic.Field()
    """
    Selection method.
    """
