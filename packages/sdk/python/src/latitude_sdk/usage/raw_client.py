...
class RawUsageClient:
    ...
    def get(self, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[UsageResponse]:
        """
...
class AsyncRawUsageClient:
    ...
    async def get(self, *, request_options: typing.Optional[RequestOptions] = None) -> AsyncHttpResponse[UsageResponse]:
        """
        Returns the organization's credit usage for the current billing period, broken down by product area and by project.
