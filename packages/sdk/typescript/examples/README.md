...
# (and LATITUDE_SESSION_ID for the filter variant). LATITUDE_API_BASE_URL is
# optional — unset means production. The API key is already
# organization-scoped server-side — the SDK no longer takes an organization
# id anywhere.
```
