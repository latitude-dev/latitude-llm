...
- Dropped-span retention no longer evicts parents before a late kept child can promote them when the
  2048-entry buffer is under pressure from unrelated dropped spans.
