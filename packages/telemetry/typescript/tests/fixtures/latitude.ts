...
export const LATITUDE_RUN_SPANS = {
  resourceSpans: [
    {
      resource: {
                ...
                },
                {
                  ...
                  value: {
                    stringValue: expectMasked(
                      '[{"id":"%ANY%","source":"api","type":"step","traceparent":"%ANY%"}]',
                    ),
                  },
                },
              ]),
            ...
            },
            {
              ...
              attributes: expect.arrayContaining([
                ...
                },
                {
                  ...
                  value: {
                    stringValue: expectMasked(
                      '[{"id":"%ANY%","source":"api","type":"step","traceparent":"%ANY%","paused":true},{"id":"%ANY%","parentId":"%ANY%","source":"api","type":"step","traceparent":"%ANY%"}]',
                    ),
                  },
                },
              ]),
            ...
            },
            {
              ...
              attributes: expect.arrayContaining([
                ...
                },
                {
                  ...
                  value: {
                    stringValue: expectMasked(
                      '[{"id":"%ANY%","source":"api","type":"step","traceparent":"%ANY%","paused":true},{"id":"%ANY%","parentId":"%ANY%","source":"api","type":"step","traceparent":"%ANY%","paused":true},{"id":"%ANY%","parentId":"%ANY%","source":"api","type":"step","traceparent":"%ANY%"}]',
                    ),
                  },
                },
              ]),
          ...
          spans: expect.arrayContaining([
            {
              ...
              attributes: expect.arrayContaining([
                ...
                },
                {
                  ...
                  value: {
                    stringValue: expectMasked(
                      '[{"id":"%ANY%","source":"api","type":"step","traceparent":"%ANY%","paused":true}]',
                    ),
                  },
                },
                {
            ...
            },
            {
              ...
              attributes: expect.arrayContaining([
                ...
                },
                {
                  ...
                  value: {
                    stringValue: expectMasked(
                      '[{"id":"%ANY%","source":"api","type":"step","traceparent":"%ANY%","paused":true},{"id":"%ANY%","parentId":"%ANY%","source":"api","type":"step","traceparent":"%ANY%","paused":true}]',
                    ),
                  },
                },
                {
