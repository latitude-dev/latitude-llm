...
export const LlamaindexIcon = forwardRef<SVGSVGElement, LucideProps>((props, ref) => (
  <svg ref={ref} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
    <path
      ...
      fill="url(#llamaindex__a)"
    />
    <defs>
      <linearGradient gradientUnits="userSpaceOnUse" id="llamaindex__a" x1="4.021" x2="24.613" y1="2.02" y2="19.277">
...
LlamaindexIcon.displayName = "LlamaindexIcon"
