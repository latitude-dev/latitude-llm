...
export const PydanticAiIcon = forwardRef<SVGSVGElement, LucideProps>((props, ref) => (
  <svg ref={ref} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120" {...props}>
    <path
...
PydanticAiIcon.displayName = "PydanticAiIcon"
