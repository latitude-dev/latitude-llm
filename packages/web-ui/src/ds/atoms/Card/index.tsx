...
import { boxShadow, BoxShadow } from '../../tokens'
    ...
    <div
      ...
      className={cn(
        ...
        boxShadow[shadow],
        {
          ...
          'bg-background-gray border dark:border-foreground/20':
            background === 'light',
        },
      )}
      {...props}
...
const CardHeader = forwardRef<HTMLDivElement, CardHeaderProps>(
  function CardHeader({ className, spacing = 'normal', ...props }, ref) {
    return (
      <div
        ref={ref}
...
const CardFooter = forwardRef<HTMLDivElement, CardFooterProps>(
  function CardFooter({ className, spacing = 'normal', ...props }, ref) {
    return (
      <div
        ref={ref}
