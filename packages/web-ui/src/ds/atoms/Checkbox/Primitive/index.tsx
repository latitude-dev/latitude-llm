...
export type CheckboxAtomProps = ComponentPropsWithoutRef<typeof CheckboxPrimitive.Root>
export type CheckedState = CheckboxPrimitive.CheckedState
const CheckboxAtom = forwardRef<ElementRef<typeof CheckboxPrimitive.Root>, CheckboxAtomProps>(
  ({ className, ...props }, ref) => (
