...
> & {
  ...
  dismissible: boolean
  height?: 'maxHeightContent' | 'maxHeightScreen'
}
    ...
    return (
      <DialogPortal>
        ...
        <DialogPrimitive.Content
          ...
          className={cn(
            'fixed left-[50%] z-50 grid w-full translate-x-[-50%] gap-4 bg-background shadow duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] rounded-lg',
            _cn,
            {
              'max-h-[90%] top-[50%] translate-y-[-50%] border dark:border':
                height === 'maxHeightContent',
              'h-[96%] top-[4%] translate-y-[-2%]':
