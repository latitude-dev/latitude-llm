export const colors = {
  ...
  borderColors: {
    ...
    foregroundMuted: 'border-muted-foreground/10',
    accentForeground: 'border-accent-foreground/10',
    successMutedForeground: 'border-success-muted-foreground/10',
    warningMutedForeground: 'border-warning-muted-foreground/10',
    destructiveMutedForeground: 'border-destructive-muted-foreground/10',
    purpleForeground: 'border-purple-foreground/10',
  },
}
