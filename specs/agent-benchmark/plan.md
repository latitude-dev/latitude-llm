...
- [x] **P6-54** Build, inspect, and freeze the latency reference from P6-4, and record its cohort
  ...
  fleet window, a 200-observation gate, and a 5-organization tenant-spread gate. TTFT had 1,281,691
  candidate readings: 21 detailed cohorts cover 78.75%, and 11 provider/model roll-ups cover 83.75%.
