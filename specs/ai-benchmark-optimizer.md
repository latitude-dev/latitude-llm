...
You can see we have @./docs/ai-benchmarks.md, which is a way to assest the
baseline of our AI features like falggers or enrichment generators. I started
working on the jailbreak falgger benchmark but I left something pending and also
